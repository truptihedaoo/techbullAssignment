...
public class PostRecyclerAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public PostRecyclerAdapter(Context mContext, List<PostItem> postItems) {
    ...
    public class ViewHolder extends BaseViewHolder {
        ...
        public void onBind(int position) {
            ...
            textViewDescription.setText( item.getYear() );
            Picasso.with( mContext ).load( String.valueOf( item.getImageUrl() ) ).placeholder( R.drawable.place_holder ).into( imgBase );
